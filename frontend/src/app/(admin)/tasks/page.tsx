...
export default function TasksPage() {
  ...
  const fetchTasks = () => {
    ...
    const url = myTasksOnly 
      ? `${process.env.NEXT_PUBLIC_API_URL || 'https://rds-db.onrender.com'}/api/tasks?my_tasks=true&user_id=${user.id}`
      : `${process.env.NEXT_PUBLIC_API_URL || 'https://rds-db.onrender.com'}/api/tasks`;
  ...
  const handleBulkComplete = async () => {
    ...
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://rds-db.onrender.com'}/api/tasks/bulk-status`, {
        method: 'PUT',
  ...
  const onDragEnd = async (result: DropResult) => {
    ...
    try {
      await fetch((process.env.NEXT_PUBLIC_API_URL || 'https://rds-db.onrender.com') + `/api/tasks/${draggableId}/status`, {
        method: 'PATCH',
        headers: { 'Content-Type': 'application/json' },
