...
export default function NotificationBell() {
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-lg border border-slate-200 z-50 overflow-hidden transform transition-all origin-top-right">
              ...
              notifications.slice(0, 5).map(notification => (
                ...
                >
                  <div className="flex justify-between items-start mb-1">
                    ...
                    {!notification.is_read && <span className="w-2 h-2 rounded-full bg-indigo-500 mt-1.5"></span>}
                  </div>
