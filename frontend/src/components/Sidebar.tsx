  ...
  return (
    <aside className="w-64 bg-slate-900 text-slate-300 min-h-screen p-5 flex flex-col border-r border-slate-800">
      ...
      <nav className="flex-1">
        <ul className="space-y-1 text-sm font-medium">
          ...
          <li className="pt-4 mt-4 border-t border-slate-800">
            <Link href="/escalations" className="flex items-center px-3 py-2.5 rounded-md hover:bg-red-900/50 text-red-400 hover:text-red-300 transition-colors">
      ...
      <div className="mt-auto border-t border-slate-800 pt-5">
        <button className="w-full flex items-center justify-center px-3 py-2 text-sm font-medium text-slate-400 hover:text-white hover:bg-slate-800 rounded-md transition-colors">
